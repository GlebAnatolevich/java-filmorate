...
public class GenreControllerTest {
    ...
    @Test
    public void getGenreByIdShouldReturnGenreWithId1() {
        Assertions.assertEquals(comedy, genreService.getGenreById(1));
    }

    @Test
    public void getGenreByIdShouldNotReturnGenreIfIdIsIncorrect() {
        Assertions.assertThrows(ObjectNotFoundException.class,
                () -> genreService.getGenreById(134));
    }

    @Test
    public void getGenresShouldReturnListOfGenres() {
